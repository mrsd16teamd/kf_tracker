  ...
  if (firstFrame) {
    ...
    */
    ...
    for (it = cluster_indices.begin(); it != cluster_indices.end(); ++it) {
      ...
      if (centroid.x < 1.5 && centroid.x > -1.5 && centroid.y > -0.75 &&
    ...
    for (int i = 0; i < n_clusters; i++) {
      {
        ...
        if (clusterCentroids.at(i).x < 1.5 && clusterCentroids.at(i).y < 0.7 &&
            clusterCentroids.at(i).y > -0.7 &&
            clusterCentroids.at(i).x > -1.5 && clusterCentroids.at(i).x != 0 &&
